...
public class SwimmingPool {
    ...
    public void handleEntryRequestDeadlockFree(Swimmer swimmer, SwimmingPoolActionOrder order) {
        // TODO 3
        if (order.equals(SwimmingPoolActionOrder.CHANGING_ROOM_BEFORE_LOCKER)) {
            handleEntryRequest(swimmer, order);
        } else {
            System.out.println("Swimmer " + swimmer.getId() + " attempted to enter in the wrong order. Entry request denied.");
        }
    }
