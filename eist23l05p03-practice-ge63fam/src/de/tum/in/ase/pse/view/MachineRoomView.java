...
public class MachineRoomView extends GridRoomView implements Observer {
	...
	public void update(Machine currMachine) {
		 ...
		 */
		currentTemperatureDisplay.setText(machine.getCurrentTemperature() + "");
		currentVoltageDisplay.setText(machine.getCurrentVoltage() + "");
		targetTemperatureDisplay.setText(machine.getTargetTemperature() + "");
		targetVoltageDisplay.setText(machine.getTargetVoltage() + "");
	}
