...
public class AssemblyControlRoomView extends ControlRoomView {
	...
	public void update(Machine currMachine) {
		 ...
		 */
		getCurrentTemperatureDisplay().setText(getMachine().getCurrentTemperature() + "");
		getCurrentVoltageDisplay().setText(getMachine().getCurrentVoltage() + "");
		...
		chipTypeDisplay.setText(assemblyMachine.getChipType().toString());
	}
